<div>
    ...
    style="height: 150px; background-image: url('{{ asset('storage/images/games.jpg') }}'); background-size: cover; background-position: center;">
        ...
        <div class="h-auto d-flex flex-wrap gap-4 ps-5 justify-content-center border-secondary-50" style="padding: 0 2rem">
            {{-- Card --}}
            ...
            <div class="d-flex justify-content-center align-items-center" >
                ...
                <div class="card-body ">
                    ...
                    <div class="d-flex flex-row">
                        <a href="#" class="card-link fm-lato d-flex flex-row gap-2" style="text-decoration: none;"><i class="bi bi-heart-fill" style="color: {{  $isLiked ? 'red' : 'white' }};"></i> <span class="text-white" >Heart</span></a>
